...
namespace ReviewApp
{
    public class Seed(PokemonContext context)
    {
        private readonly PokemonContext _pokemonContext = context;

        public void SeedDataContext()
        {
            if (_pokemonContext.PokemonOwners.Any()) return;
            ...
            _pokemonContext.PokemonOwners.AddRange(pokemonOwners);
